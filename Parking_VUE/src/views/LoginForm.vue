            ...
            <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last lateral">
              <div class="text w-100 pt-50" style="margin-top: 95%;">
                <div class="d-md-flex">
                  ...
                  <a href="#" class="button is-dark" style="height: 27px;border-radius: 50px;margin-left: 22px;">Registrate</a>
                </div>
            ...
            <div class="login-wrap p-4 p-lg-5">
              ...
              <form class="signin-form" method="POST">
                ...
                <div class="form-group">
                  <button type="submit" class="form-control px-3 button is-dark" @click="logintest">Ingresar</button>
                </div>
              </form>
            </div>
          </div>
